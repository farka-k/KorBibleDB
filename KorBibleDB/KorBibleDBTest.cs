...
{
    public partial class KorBibleDBTest : Form
    {
        ...
        private void BtnCreateDB_Click(object sender, EventArgs e)
        {
            ...
            string sql = "create table if not exists Books (Name varchar(10), Abbr varchar(2), Testament varchar(2), Chapters int, PRIMARY KEY (Name))";
